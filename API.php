...
namespace Piwik\Plugins\IslandoraReports;

use Piwik\DataTable;
use Piwik\DataTable\Row;

/**
 * API for plugin IslandoraReports
 *
 * @method static \Piwik\Plugins\IslandoraReports\API getInstance()
 */
class API extends \Piwik\Plugin\API
{
     ...
     * /index.php?module=API&method=IslandoraReports.getAnswerToLife
     * /index.php?module=API&method=IslandoraReports.getAnswerToLife&truth=0
     *
     * @param  bool $truth
     *
     * @return int
